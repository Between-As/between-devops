...
helm.sh/chart: {{ include "crm-backend.chart" . }}
{{ include "crm-backend.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "crm-backend.selectorLabels" -}}
app.kubernetes.io/name: {{ include "crm-backend.name" . }}
